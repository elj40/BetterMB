// Class to manage cached data of the user
// Basically the same as the one for the CLI
// TODO: consider add it to a "common" subproject
...
class GuiUser
{
    ...
    public GuiUser(int su)
    {
        studentNumber = su;
    };
    static void debug(String s)
    {
        if (GuiUser.debugging) System.out.println(s);
    }
